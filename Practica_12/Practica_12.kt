...
// Implementación de una lista personalizada para gestionar tareas
class CustomList<T> {
...
// Implementación de un árbol binario para organizar las tareas por prioridad
class ArbolTareas {
    private var raiz: NodoArbol? = null
...
// Código principal que gestiona la interacción con el usuario
fun main() {
    ...
    do {
        ...
        println("4. ver lista de tareas ordenadas por prioridad")
        println("5. salir")
